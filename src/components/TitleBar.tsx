...
export const TitleBar: React.FC<{ onRequestClose?: () => void }> = ({ onRequestClose }) => {
  return (
    <div className="relative z-50 h-10 w-full">
      <div className="flex items-center h-full w-full backdrop-blur-sm backdrop-brightness-110 border-b border-line select-none">
        <div
          className="flex items-center h-full px-4 space-x-2"
          style={{ WebkitAppRegion: 'drag' } as React.CSSProperties}
        >
          <img src={logoUrl} alt="Vocari" className="vocari-mark h-4" />
        ...
        >
          ...
          <button
            type="button"
            className="w-10 h-8 hover:bg-white/10 rounded-lg flex items-center justify-center"
